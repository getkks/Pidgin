...
internal static class EnumerableExtensions {
	...
	private static class _FastCompare<T> {
		...
		public static int Go( ImmutableArray<T> left, ImmutableArray<T> right ) => _callFastCompare is null ? SlowCompare(left, right) : _callFastCompare(left, right);
	}

	private static class _FastEqual<T> {
		...
		public static bool Go( ImmutableArray<T> left, ImmutableArray<T> right ) => _callFastEqual is null ? SlowEqual(left, right) : _callFastEqual(left, right);
	}
}
