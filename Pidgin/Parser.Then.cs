...
public abstract partial class Parser<TToken, T> {
	...
	public Parser<TToken, U> Then<U>( Parser<TToken, U> parser ) => Then(parser, ( t, u ) => u);
	...
	public Parser<TToken, U> Then<U>( Func<T, Parser<TToken, U>> selector ) => Bind(selector);
	...
	/// <returns>A parser which applies the current parser before applying the result of the <paramref name="selector"/> function</returns>
	public Parser<TToken, R> Then<U, R>( Func<T, Parser<TToken, U>> selector, Func<T, U, R> result ) => Bind(selector, result);
}
